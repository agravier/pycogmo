...
class InputLayer(object):
    """Wraps a 2D array of electrodes with the same dimensions as the
    PyNN population in which it injects current. The stimulation
    scale can be adjusted by providing the max input amplitude in nA."""
...
class InputSample(object):
    ...
    the same dimensions as the InputLayer to which it is prented."""
    TODO
